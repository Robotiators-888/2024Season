...
public final class Constants {
  ...
  public static class PhotonVision {
    ...
    public static final Transform3d kCameraToRobot = new Transform3d(Units.inchesToMeters(-15.5 + 2.25),
        Units.inchesToMeters(12.0 - 3.75), Units.inchesToMeters(15.5), cameraRotation);

...
ks=0;
    ...
    SmartDashboard.putNumber("AUTOAIM/Distance error", positionError);
  ...
  public void end(boolean interrupted) {
    SUB_LEDs.ledValue = BlinkinPattern.STROBE_WHITE.value;
  }

  // Returns true when the command should end.
  @Override
  public boolean isFinished() {
    return Math.abs(pivot.calculateDegreesRotation()-pivot.distToPivotAngle.get(positionError)) < 3 && robotAngleController.atSetpoint();
  }
}

...
/** Add your docs here. */
public class AUTO_MidLine_Bottom_Four extends AutoPaths {
    ...
    public Command load(AutoGenerator autos) {
        ...
        String p5Name = "Bottom_to_3GP";
        String p6Name = "3rd_to_BottomGP";
        ...
        return new SequentialCommandGroup(
            ...
            autos.pathIntake(p5Name).withTimeout(4),
            autos.setPivotSetpoint(Pivot.kLowAngleSP),
            PathPlannerBase.followTrajectory(p6Name).withTimeout(4),
            autos.scoringSequence(Pivot.kLowAngleSP-1, 4500, 0.5)
